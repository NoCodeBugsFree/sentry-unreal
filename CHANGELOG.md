...
- Bump Java SDK (Android) from v7.20.0 to v8.4.0 ([#20](https://github.com/NoCodeBugsFree/sentry-unreal/pull/20))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#840)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.20.0...8.4.0)
