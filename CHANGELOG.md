...
- Bump Java SDK (Android) from v7.20.0 to v8.15.1 ([#60](https://github.com/NoCodeBugsFree/sentry-unreal/pull/60))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8151)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.20.0...8.15.1)
