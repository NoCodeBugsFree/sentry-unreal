...
- Bump Cocoa SDK (iOS and Mac) from v8.43.0 to v9.5.1 ([#142](https://github.com/NoCodeBugsFree/sentry-unreal/pull/142))
  - [changelog](https://github.com/getsentry/sentry-cocoa/blob/main/CHANGELOG.md#951)
  - [diff](https://github.com/getsentry/sentry-cocoa/compare/8.43.0...9.5.1)
