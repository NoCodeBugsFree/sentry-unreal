...
- Bump Java SDK (Android) from v7.20.0 to v8.5.0 ([#22](https://github.com/NoCodeBugsFree/sentry-unreal/pull/22))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#850)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.20.0...8.5.0)
