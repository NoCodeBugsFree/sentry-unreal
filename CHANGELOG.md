...
- Bump Java SDK (Android) from v7.20.0 to v8.37.0 ([#158](https://github.com/NoCodeBugsFree/sentry-unreal/pull/158))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8370)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.20.0...8.37.0)
