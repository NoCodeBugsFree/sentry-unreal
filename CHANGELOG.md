...
- Bump Cocoa SDK (iOS and Mac) from v8.43.0 to v9.4.0 ([#130](https://github.com/NoCodeBugsFree/sentry-unreal/pull/130))
  - [changelog](https://github.com/getsentry/sentry-cocoa/blob/main/CHANGELOG.md#940)
  - [diff](https://github.com/getsentry/sentry-cocoa/compare/8.43.0...9.4.0)
