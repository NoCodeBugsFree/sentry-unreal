...
- Bump Java SDK (Android) from v7.20.0 to v8.43.0 ([#187](https://github.com/NoCodeBugsFree/sentry-unreal/pull/187))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8430)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.20.0...8.43.0)
