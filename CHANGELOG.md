...
- Bump Java SDK (Android) from v7.20.0 to v8.50.0 ([#217](https://github.com/NoCodeBugsFree/sentry-unreal/pull/217))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8500)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.20.0...8.50.0)
