...
- Bump Java SDK (Android) from v7.20.0 to v8.39.0 ([#167](https://github.com/NoCodeBugsFree/sentry-unreal/pull/167))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8390)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.20.0...8.39.0)
