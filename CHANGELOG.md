...
- Bump Java SDK (Android) from v7.20.0 to v8.8.0 ([#31](https://github.com/NoCodeBugsFree/sentry-unreal/pull/31))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#880)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.20.0...8.8.0)
