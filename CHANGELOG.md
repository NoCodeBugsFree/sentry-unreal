...
- Bump Java SDK (Android) from v7.20.0 to v8.47.0 ([#206](https://github.com/NoCodeBugsFree/sentry-unreal/pull/206))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8470)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.20.0...8.47.0)
