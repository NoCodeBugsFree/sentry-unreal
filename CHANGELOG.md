...
- Bump Cocoa SDK (iOS and Mac) from v8.43.0 to v9.0.0 ([#112](https://github.com/NoCodeBugsFree/sentry-unreal/pull/112))
  - [changelog](https://github.com/getsentry/sentry-cocoa/blob/main/CHANGELOG.md#900)
  - [diff](https://github.com/getsentry/sentry-cocoa/compare/8.43.0...9.0.0)
