...
- Bump Java SDK (Android) from v7.20.0 to v8.54.0 ([#231](https://github.com/NoCodeBugsFree/sentry-unreal/pull/231))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8540)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.20.0...8.54.0)
