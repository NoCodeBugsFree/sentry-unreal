...
- Bump Cocoa SDK (iOS and Mac) from v8.43.0 to v9.6.0 ([#146](https://github.com/NoCodeBugsFree/sentry-unreal/pull/146))
  - [changelog](https://github.com/getsentry/sentry-cocoa/blob/main/CHANGELOG.md#960)
  - [diff](https://github.com/getsentry/sentry-cocoa/compare/8.43.0...9.6.0)
