...
- Bump Java SDK (Android) from v7.20.0 to v8.18.0 ([#68](https://github.com/NoCodeBugsFree/sentry-unreal/pull/68))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8180)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.20.0...8.18.0)
