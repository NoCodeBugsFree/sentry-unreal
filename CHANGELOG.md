...
- Bump Java SDK (Android) from v7.20.0 to v8.22.0 ([#86](https://github.com/NoCodeBugsFree/sentry-unreal/pull/86))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8220)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.20.0...8.22.0)
