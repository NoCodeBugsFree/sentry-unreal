...
- Bump Java SDK (Android) from v7.20.0 to v8.45.0 ([#202](https://github.com/NoCodeBugsFree/sentry-unreal/pull/202))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8450)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.20.0...8.45.0)
