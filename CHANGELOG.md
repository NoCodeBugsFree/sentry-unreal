...
- Bump Cocoa SDK (iOS and Mac) from v8.43.0 to v9.10.0 ([#164](https://github.com/NoCodeBugsFree/sentry-unreal/pull/164))
  - [changelog](https://github.com/getsentry/sentry-cocoa/blob/main/CHANGELOG.md#9100)
  - [diff](https://github.com/getsentry/sentry-cocoa/compare/8.43.0...9.10.0)
