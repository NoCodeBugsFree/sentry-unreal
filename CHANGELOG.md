...
- Bump Java SDK (Android) from v7.20.0 to v8.26.0 ([#107](https://github.com/NoCodeBugsFree/sentry-unreal/pull/107))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8260)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.20.0...8.26.0)
