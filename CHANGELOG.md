...
- Bump Java SDK (Android) from v7.20.0 to v8.27.1 ([#110](https://github.com/NoCodeBugsFree/sentry-unreal/pull/110))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8271)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.20.0...8.27.1)
