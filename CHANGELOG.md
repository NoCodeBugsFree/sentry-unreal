...
- Bump Java SDK (Android) from v7.20.0 to v8.11.1 ([#39](https://github.com/NoCodeBugsFree/sentry-unreal/pull/39))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8111)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.20.0...8.11.1)
