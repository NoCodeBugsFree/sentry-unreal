...
- Bump Java SDK (Android) from v7.20.0 to v8.7.0 ([#29](https://github.com/NoCodeBugsFree/sentry-unreal/pull/29))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#870)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.20.0...8.7.0)
