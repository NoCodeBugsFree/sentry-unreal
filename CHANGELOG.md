...
- Bump Java SDK (Android) from v7.20.0 to v8.12.0 ([#44](https://github.com/NoCodeBugsFree/sentry-unreal/pull/44))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8120)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.20.0...8.12.0)
