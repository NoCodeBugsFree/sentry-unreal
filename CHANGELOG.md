...
- Bump Java SDK (Android) from v7.20.0 to v8.24.0 ([#98](https://github.com/NoCodeBugsFree/sentry-unreal/pull/98))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8240)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.20.0...8.24.0)
