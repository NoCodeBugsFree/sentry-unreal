...
- Bump Java SDK (Android) from v7.20.0 to v8.16.0 ([#61](https://github.com/NoCodeBugsFree/sentry-unreal/pull/61))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8160)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.20.0...8.16.0)
