...
- Bump Java SDK (Android) from v7.20.0 to v8.29.0 ([#118](https://github.com/NoCodeBugsFree/sentry-unreal/pull/118))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8290)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.20.0...8.29.0)
