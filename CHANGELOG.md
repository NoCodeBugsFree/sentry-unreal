...
- Bump Cocoa SDK (iOS and Mac) from v8.43.0 to v9.2.0 ([#125](https://github.com/NoCodeBugsFree/sentry-unreal/pull/125))
  - [changelog](https://github.com/getsentry/sentry-cocoa/blob/main/CHANGELOG.md#920)
  - [diff](https://github.com/getsentry/sentry-cocoa/compare/8.43.0...9.2.0)
