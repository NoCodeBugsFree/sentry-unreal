...
- Bump Java SDK (Android) from v7.20.0 to v8.56.0 ([#238](https://github.com/NoCodeBugsFree/sentry-unreal/pull/238))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8560)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.20.0...8.56.0)
