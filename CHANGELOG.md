...
- Bump Cocoa SDK (iOS and Mac) from v8.43.0 to v9.22.0 ([#211](https://github.com/NoCodeBugsFree/sentry-unreal/pull/211))
  - [changelog](https://github.com/getsentry/sentry-cocoa/blob/main/CHANGELOG.md#9220)
  - [diff](https://github.com/getsentry/sentry-cocoa/compare/8.43.0...9.22.0)
