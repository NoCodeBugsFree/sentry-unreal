...
- Bump Cocoa SDK (iOS and Mac) from v8.43.0 to v9.14.0 ([#185](https://github.com/NoCodeBugsFree/sentry-unreal/pull/185))
  - [changelog](https://github.com/getsentry/sentry-cocoa/blob/main/CHANGELOG.md#9140)
  - [diff](https://github.com/getsentry/sentry-cocoa/compare/8.43.0...9.14.0)
