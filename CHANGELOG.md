...
- Bump Java SDK (Android) from v7.20.0 to v8.10.0 ([#35](https://github.com/NoCodeBugsFree/sentry-unreal/pull/35))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8100)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.20.0...8.10.0)
