...
- Bump Java SDK (Android) from v7.20.0 to v8.35.0 ([#153](https://github.com/NoCodeBugsFree/sentry-unreal/pull/153))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8350)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.20.0...8.35.0)
