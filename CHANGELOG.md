...
- Bump Java SDK (Android) from v7.20.0 to v8.27.0 ([#109](https://github.com/NoCodeBugsFree/sentry-unreal/pull/109))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8270)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.20.0...8.27.0)
