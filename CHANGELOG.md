...
- Bump Java SDK (Android) from v7.20.0 to v8.23.0 ([#92](https://github.com/NoCodeBugsFree/sentry-unreal/pull/92))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8230)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.20.0...8.23.0)
