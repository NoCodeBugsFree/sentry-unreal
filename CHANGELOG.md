...
- Bump Java SDK (Android) from v7.20.0 to v8.13.2 ([#51](https://github.com/NoCodeBugsFree/sentry-unreal/pull/51))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8132)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.20.0...8.13.2)
