...
- Bump Java SDK (Android) from v7.20.0 to v8.19.0 ([#73](https://github.com/NoCodeBugsFree/sentry-unreal/pull/73))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8190)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.20.0...8.19.0)
