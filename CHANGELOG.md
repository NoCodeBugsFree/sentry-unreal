...
- Bump Java SDK (Android) from v7.20.0 to v8.38.0 ([#165](https://github.com/NoCodeBugsFree/sentry-unreal/pull/165))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8380)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.20.0...8.38.0)
