...
- Bump Java SDK (Android) from v7.20.0 to v8.3.0 ([#15](https://github.com/NoCodeBugsFree/sentry-unreal/pull/15))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#830)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.20.0...8.3.0)
