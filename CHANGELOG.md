...
- Bump Java SDK (Android) from v7.20.0 to v8.15.0 ([#59](https://github.com/NoCodeBugsFree/sentry-unreal/pull/59))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8150)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.20.0...8.15.0)
