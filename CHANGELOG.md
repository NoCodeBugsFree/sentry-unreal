...
- Bump Java SDK (Android) from v7.20.0 to v8.14.0 ([#56](https://github.com/NoCodeBugsFree/sentry-unreal/pull/56))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8140)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.20.0...8.14.0)
