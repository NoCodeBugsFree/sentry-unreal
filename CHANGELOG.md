...
- Bump Java SDK (Android) from v7.20.0 to v8.6.0 ([#28](https://github.com/NoCodeBugsFree/sentry-unreal/pull/28))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#860)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.20.0...8.6.0)
