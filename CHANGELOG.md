...
- Bump Cocoa SDK (iOS and Mac) from v8.43.0 to v9.5.0 ([#138](https://github.com/NoCodeBugsFree/sentry-unreal/pull/138))
  - [changelog](https://github.com/getsentry/sentry-cocoa/blob/main/CHANGELOG.md#950)
  - [diff](https://github.com/getsentry/sentry-cocoa/compare/8.43.0...9.5.0)
