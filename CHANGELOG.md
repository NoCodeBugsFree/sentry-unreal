...
- Bump Java SDK (Android) from v7.20.0 to v8.19.1 ([#74](https://github.com/NoCodeBugsFree/sentry-unreal/pull/74))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8191)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.20.0...8.19.1)
