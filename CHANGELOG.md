...
- Bump Java SDK (Android) from v7.20.0 to v8.34.0 ([#147](https://github.com/NoCodeBugsFree/sentry-unreal/pull/147))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8340)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.20.0...8.34.0)
