...
- Bump Cocoa SDK (iOS and Mac) from v8.43.0 to v9.9.0 ([#162](https://github.com/NoCodeBugsFree/sentry-unreal/pull/162))
  - [changelog](https://github.com/getsentry/sentry-cocoa/blob/main/CHANGELOG.md#990)
  - [diff](https://github.com/getsentry/sentry-cocoa/compare/8.43.0...9.9.0)
