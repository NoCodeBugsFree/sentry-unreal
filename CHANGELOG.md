...
- Bump Java SDK (Android) from v7.20.0 to v8.57.0 ([#240](https://github.com/NoCodeBugsFree/sentry-unreal/pull/240))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8570)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.20.0...8.57.0)
