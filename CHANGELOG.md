...
- Bump Java SDK (Android) from v7.20.0 to v8.55.0 ([#234](https://github.com/NoCodeBugsFree/sentry-unreal/pull/234))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8550)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.20.0...8.55.0)
