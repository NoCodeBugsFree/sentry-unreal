...
- Bump Cocoa SDK (iOS and Mac) from v8.43.0 to v8.52.0 ([#52](https://github.com/NoCodeBugsFree/sentry-unreal/pull/52))
  - [changelog](https://github.com/getsentry/sentry-cocoa/blob/main/CHANGELOG.md#8520)
  - [diff](https://github.com/getsentry/sentry-cocoa/compare/8.43.0...8.52.0)
