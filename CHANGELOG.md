...
- Bump Java SDK (Android) from v7.20.0 to v8.48.0 ([#210](https://github.com/NoCodeBugsFree/sentry-unreal/pull/210))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8480)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.20.0...8.48.0)
