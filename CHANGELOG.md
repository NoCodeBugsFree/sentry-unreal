...
- Bump Java SDK (Android) from v7.20.0 to v8.13.1 ([#49](https://github.com/NoCodeBugsFree/sentry-unreal/pull/49))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8131)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.20.0...8.13.1)
