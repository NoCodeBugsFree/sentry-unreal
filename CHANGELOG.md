...
- Bump Java SDK (Android) from v7.20.0 to v8.41.0 ([#178](https://github.com/NoCodeBugsFree/sentry-unreal/pull/178))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8410)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.20.0...8.41.0)
