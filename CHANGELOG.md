...
- Bump Java SDK (Android) from v7.20.0 to v8.43.2 ([#192](https://github.com/NoCodeBugsFree/sentry-unreal/pull/192))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8432)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.20.0...8.43.2)
