...
- Bump Java SDK (Android) from v7.20.0 to v8.44.0 ([#196](https://github.com/NoCodeBugsFree/sentry-unreal/pull/196))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8440)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.20.0...8.44.0)
