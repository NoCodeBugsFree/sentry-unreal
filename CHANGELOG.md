...
- Bump Cocoa SDK (iOS and Mac) from v8.43.0 to v9.1.0 ([#115](https://github.com/NoCodeBugsFree/sentry-unreal/pull/115))
  - [changelog](https://github.com/getsentry/sentry-cocoa/blob/main/CHANGELOG.md#910)
  - [diff](https://github.com/getsentry/sentry-cocoa/compare/8.43.0...9.1.0)
