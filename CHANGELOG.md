...
- Bump Java SDK (Android) from v7.20.0 to v8.51.0 ([#221](https://github.com/NoCodeBugsFree/sentry-unreal/pull/221))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8510)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.20.0...8.51.0)
