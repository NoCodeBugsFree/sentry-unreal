...
- Bump Cocoa SDK (iOS and Mac) from v8.43.0 to v9.3.0 ([#128](https://github.com/NoCodeBugsFree/sentry-unreal/pull/128))
  - [changelog](https://github.com/getsentry/sentry-cocoa/blob/main/CHANGELOG.md#930)
  - [diff](https://github.com/getsentry/sentry-cocoa/compare/8.43.0...9.3.0)
