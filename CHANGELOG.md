...
- Bump Java SDK (Android) from v7.20.0 to v8.33.0 ([#137](https://github.com/NoCodeBugsFree/sentry-unreal/pull/137))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8330)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.20.0...8.33.0)
