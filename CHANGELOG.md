...
- Bump Cocoa SDK (iOS and Mac) from v8.43.0 to v8.56.2 ([#90](https://github.com/NoCodeBugsFree/sentry-unreal/pull/90))
  - [changelog](https://github.com/getsentry/sentry-cocoa/blob/main/CHANGELOG.md#8562)
  - [diff](https://github.com/getsentry/sentry-cocoa/compare/8.43.0...8.56.2)
