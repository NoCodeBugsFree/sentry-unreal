...
- Bump Java SDK (Android) from v7.20.0 to v8.46.0 ([#203](https://github.com/NoCodeBugsFree/sentry-unreal/pull/203))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8460)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.20.0...8.46.0)
