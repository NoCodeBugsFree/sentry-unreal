...
- Bump Cocoa SDK (iOS and Mac) from v8.43.0 to v9.24.0 ([#220](https://github.com/NoCodeBugsFree/sentry-unreal/pull/220))
  - [changelog](https://github.com/getsentry/sentry-cocoa/blob/main/CHANGELOG.md#9240)
  - [diff](https://github.com/getsentry/sentry-cocoa/compare/8.43.0...9.24.0)
