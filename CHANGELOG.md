...
- Bump Java SDK (Android) from v7.20.0 to v8.21.1 ([#82](https://github.com/NoCodeBugsFree/sentry-unreal/pull/82))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8211)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.20.0...8.21.1)
