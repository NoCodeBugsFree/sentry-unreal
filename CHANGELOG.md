...
- Bump Java SDK (Android) from v7.20.0 to v8.50.1 ([#218](https://github.com/NoCodeBugsFree/sentry-unreal/pull/218))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8501)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.20.0...8.50.1)
