...
- Bump Java SDK (Android) from v7.20.0 to v8.32.0 ([#133](https://github.com/NoCodeBugsFree/sentry-unreal/pull/133))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8320)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.20.0...8.32.0)
