...
- Bump Java SDK (Android) from v7.20.0 to v8.40.0 ([#171](https://github.com/NoCodeBugsFree/sentry-unreal/pull/171))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8400)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.20.0...8.40.0)
