...
- Bump Java SDK (Android) from v7.20.0 to v8.30.0 ([#124](https://github.com/NoCodeBugsFree/sentry-unreal/pull/124))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8300)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.20.0...8.30.0)
