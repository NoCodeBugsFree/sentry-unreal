...
- Bump Java SDK (Android) from v7.20.0 to v8.34.1 ([#148](https://github.com/NoCodeBugsFree/sentry-unreal/pull/148))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8341)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.20.0...8.34.1)
