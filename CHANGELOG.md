...
- Bump Java SDK (Android) from v7.20.0 to v8.9.0 ([#34](https://github.com/NoCodeBugsFree/sentry-unreal/pull/34))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#890)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.20.0...8.9.0)
