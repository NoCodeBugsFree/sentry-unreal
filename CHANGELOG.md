...
- Bump Java SDK (Android) from v7.20.0 to v8.20.0 ([#77](https://github.com/NoCodeBugsFree/sentry-unreal/pull/77))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8200)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.20.0...8.20.0)
