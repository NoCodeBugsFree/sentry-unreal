...
- Bump Java SDK (Android) from v7.20.0 to v8.28.0 ([#113](https://github.com/NoCodeBugsFree/sentry-unreal/pull/113))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8280)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.20.0...8.28.0)
