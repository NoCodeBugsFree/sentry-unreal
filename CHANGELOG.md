...
- Bump Cocoa SDK (iOS and Mac) from v8.43.0 to v9.7.0 ([#151](https://github.com/NoCodeBugsFree/sentry-unreal/pull/151))
  - [changelog](https://github.com/getsentry/sentry-cocoa/blob/main/CHANGELOG.md#970)
  - [diff](https://github.com/getsentry/sentry-cocoa/compare/8.43.0...9.7.0)
